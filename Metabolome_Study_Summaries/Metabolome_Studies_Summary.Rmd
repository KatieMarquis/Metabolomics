...
#retrive study names
study_names <- list.files("/home/kmarquis/CVL_Fluid_Metabolomics_Analysis/Studies")

#create empty list
datalist <- list()

#retrieve data from individual metabolomics studies and add to datalist
for (study in study_names) {
  
  path <- paste0("/home/kmarquis/CVL_Fluid_Metabolomics_Analysis/Studies/", study, "/", study, "_data_summary.xlsx")
...
matched_lit <- process_corrected_names(infile = 'lit_metabolites_key.csv', match_data = lit_data) #file name from interface py output
...
#rerun py script with manually corrected names
source_python('HMDB_search.py')
